...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-store  fa-fw"></i> &nbsp; CARGOS DE LA EMPRESA 
                </h3>
                    ...
                    <table class="table table-dark table-sm">
                        <thead>
                            <tr class="text-center roboto-medium">
                                ...
                                <th class="text-center">SUELDO<br> </th>
            ...
            <div id="cuadroFormulario" class="container-fluid">
                ...
                <div class="container-fluid form-neon">
                    ...
                    <form id="frm_Cargo" action="" autocomplete="off">
                        <fieldset>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            <label for="txt_cargo" class="roboto-medium">NOMBRE</label>
                                            <input type="text" class="form-control text-uppercase" name="txt_cargo" id="txt_cargo" minlength="2" maxlength="125" required>
                                            <div id="cargoError">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="txt_descripcion" id="txt_descripcion" minlength="2" maxlength="125" required>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            <label for="txt_sueldo" class="roboto-medium">SUELDO</label>
                                            <input type="number" class="form-control text-uppercase" name="txt_sueldo" id="txt_sueldo" minlength="3" maxlength="125" required>
                                            <div id="sueldoError">
    ...
    <script src="../../js_app/cargo.js"></script>
