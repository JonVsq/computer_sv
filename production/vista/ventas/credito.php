...
<body>
    ...
    <main class="full-box main-container">
            ...
            <div class="full-box nav-lateral-content">
                <figure class="full-box nav-lateral-avatar">
                    ...
                    <figcaption class="roboto-medium text-center">
                        NOMBRE
                        <br><small class="roboto-condensed-light">VENDEDOR</small>
                    </figcaption>
                </figure>
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-hand-holding-usd  fa-fw"></i> &nbsp; VENTA AL CREDITO
                </h3>
                        ...
                        <fieldset>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <span class="roboto-medium">PLAZO CANCELACION: </span>
                                            <input type="hidden" id="txt_idplazo" name="txt_idplazo">
                                            <span id="spn_Plazo" class="text-danger">&nbsp; <i class="fas fa-exclamation-triangle"></i> SELECCIONE PLAZO</span>
                                            <button id="btn_modalPlazo" type="button" class="btn btn-info btn-sm"><i class="fas fa-list"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- MODAL PLAZO -->
            <div class="modal fade" id="ModalPlazo" tabindex="-1" role="dialog" aria-labelledby="ModalCliente" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title roboto-medium" id="Modal1">LISTA DE PLAZOS E INTERES</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <div class="container-fluid">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-bordered table-sm roboto-medium">
                                        <thead>
                                            <tr class="text-center">
                                                <td>PLAZO (MESES)<br> <input type="text" id="txt_buscarPlazo" name="txt_buscarPlazo"></td>
                                                <td>INTERES %<br> <input type="text" id="txt_buscarInteres" name="txt_buscarInteres"></td>
                                                <td>SELECCIONAR</td>
                                            </tr>
                                        </thead>
                                        <tbody id="cuerpoTablaPlazo">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <p id="registrosPlazo" class="text-left roboto-medium"></p>
                                                </div>
                                            </div>

                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <p id="totalPaginasPlazo" class="text-right roboto-medium"></p>
                                                </div>
                                            </div>


                                        </div>
                                        <ul id="paginadorPlazo" class="pagination justify-content-center">
    ...
    <script src="../../js_app/venta_credito.js"></script>
