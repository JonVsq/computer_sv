...
const txt_unidadPeriodo = document.getElementById('txt_unidadPeriodo')
const txt_costoPedido = document.getElementById('txt_costoPedido')
const txt_costoMantenimiento = document.getElementById('txt_costoMantenimiento')
...
function cargarFormulario(id) {
    ...
    fetch(urlProducto, {
        ...
        if (respuesta[0] == null) {
            ...
            txt_unidadPeriodo.value = respuesta[0]['unidades_periodo']
            txt_costoPedido.value = respuesta[0]['costo_unitario_pedido']
            txt_costoMantenimiento.value = respuesta[0]['costo_mantenimiento']
