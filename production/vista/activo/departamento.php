...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-store  fa-fw"></i> &nbsp; DEPARTAMENTOS
                </h3>
                    ...
                    <table class="table table-dark table-sm">
                        <thead>
                            <tr class="text-center roboto-medium">
                                <th class="text-center">CÓDIGO<br> <input type="text" name="txt_filtros" id="txt_filtros" autocomplete="off"></th>
            ...
            <div id="cuadroFormulario" class="container-fluid" style="display: none">
                ...
                <div class="container-fluid form-neon">
                    ...
                    <form id="frm_Departamento" action="" autocomplete="off">
                        <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="txt_ubicacion" id="txt_ubicacion" minlength="2" maxlength="125" required>
                                            <div id="ubicacionError">
    ...
    <script src="../../js_app/departamento.js"></script>
