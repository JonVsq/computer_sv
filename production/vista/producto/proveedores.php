                    ...
                    <table class="table table-dark table-sm">
                        <thead>
                            <tr class="text-center roboto-medium">
                                ...
                                <th class="text-center">DIAS PARA ENTREGAR PEDIDO</th>
                        ...
                        <fieldset>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="txt_diasEntrega" class="roboto-medium">DIAS EN ENTREGAR LOS PEDIDOS</label>
                                            <input type="number" class="form-control text-uppercase" name="txt_diasEntrega" id="txt_diasEntrega" min="1" max="100" required>
                                            <div id="diasError">
