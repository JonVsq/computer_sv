...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase" name="txt_dui" id="txt_dui" required>
                                            <div id="duiError">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="txt_estadoCivil" class="roboto-medium">ESTADO CIVIL</label>
                                            <br>
                                            <select id="txt_estadoCivil" class="select btn btn-block" style="border-color: black;" name="txt_estadoCivil">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="txt_lugarTrabajo" class="roboto-medium">LUGAR DE TRABAJO</label>
                                            <input type="text" class="form-control text-uppercase" name="txt_lugarTrabajo" id="txt_lugarTrabajo" minlength="3" maxlength="250" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="txt_ingresos" class="roboto-medium">INGRESOS</label>
                                            <input type="number" class="form-control text-uppercase" name="txt_ingresos" id="txt_ingresos" min="3" max="100000" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="txt_egresos" class="roboto-medium">EGRESOS</label>
                                            <input type="number" class="form-control text-uppercase" name="txt_egresos" id="txt_egresos" min="3" max="100000" required>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../../js_app/cliente_natural.js"></script>
