...
class Nucleo
{
    ...
    //ALMACENA UNA CONDICION AND
    private $and;
    private $consultarModificar = false;
    ...
    public function coincidencias($datos, $identificador, $id)
    {
        return  $this->consultarCoincidencias($datos, $identificador, $id);
    }
    ...
    /**
     * Get the value of consultarModificar
     */
    public function getConsultarModificar()
    {
        return $this->consultarModificar;
    }

    /**
     * Set the value of consultarModificar
     *
     * @return  self
     */
    public function setConsultarModificar($consultarModificar)
    {
        $this->consultarModificar = $consultarModificar;
