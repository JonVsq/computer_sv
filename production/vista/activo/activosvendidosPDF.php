...
<div id="project">
<div style=" text-align: center;"> REPORTE DE ACTIVOS VENDIDOS</div>
<br>  
...
<th class="desc" style="text-align: center;">COMPRADOR</th>
<th class="desc" style="text-align: center;">PRECIO VENTA $</th>
<th class="desc" style="text-align: center;">FECHA VENTA</th>
</tr>
</thead>
<tbody>
';
foreach ($activos as $activo) {
  ...
  $plantilla .= '<td class="service" style="text-align: center;">' . $activo["comprador"] . '</td>';
  $plantilla .= '<td class="service" style="text-align: center;">' . $activo["precioventa"] . '</td>';
